...
\begin{document}
    ...
    \section{Education}
        ...
        \begin{onecolentry}
            \begin{highlights}
                \item \textbf{Coursework:} Data Structures, Computer Architecture, Discrete Math, Calculus I-III
            \end{highlights}
        \end{onecolentry}
    ...
    \section{Experience}
        ...
        \textit{Sep 2021 to Dec 2023}}
            \textbf{Double Bassist}
            
            \textit{Take Five String Quintet}
        \end{twocolentry}

        \vspace{0.10 cm}
        \begin{onecolentry}
            \begin{highlights}
                \item Annually played paid Christmas gigs and at weddings locally, prepared unique repertoire and participated in coordinated rehearsals.
                \item Performed for specific school events and external gigs such as at church, volunteered at Living Word Lutheran Church services, as well as LCISD hosted events.
                \item Honored to play for the Superintendent and Board of Directors at the Promise to Parents Brunch event.
            \end{highlights}
        \end{onecolentry}
    ...
    \section{Skills}
        ...
        \begin{onecolentry}
            \textbf{Soft Skills:} Strong Work Ethic, Time Management, Customer-Awareness, Adaptability
        \end{onecolentry}

        \vspace{0.2 cm}

        \begin{onecolentry}
            \textbf{Hard Skills:} Toast System, MS Office, Adobe Premiere Pro, MuseScore
        \end{onecolentry}

        \vspace{0.2 cm}

        \begin{onecolentry}
            \textbf{Languages:} English (Fluent), Urdu (Conversational)
        \end{onecolentry}


    
    \section{Hobbies, Interests, Availability}



        
        \begin{onecolentry}
            \textbf{Hobbies:} Bodybuilding/Fitness, Motorcycling, Double Bass
        \end{onecolentry}

        \vspace{0.2 cm}

        \begin{onecolentry}
            \textbf{Interests:} Pharmacology, Latte Art/Coffee, Nutrition, Music Theory
        \end{onecolentry}

        \vspace{0.2 cm}

        \begin{onecolentry}
            \textbf{Availability:} Prefer to work Tuesdays and Saturdays past 4pm, can occassionally pick up shifts
        \end{onecolentry}
