...
\begin{document}
    ...
    \section{Hobbies, Interests, Goals}



        
        \begin{onecolentry}
            \textbf{Hobbies:} Bodybuilding/Fitness, Motorcycle Riding, Double Bass
        \end{onecolentry}

        \vspace{0.2 cm}

        \begin{onecolentry}
            \textbf{Interests:} Photography, Fashion, Latte Art/Coffee, Nutrition, Music Theory
        \end{onecolentry}

        \vspace{0.2 cm}

        \begin{onecolentry}
            \textbf{Goals:} Join HEB for the long-term as a part-time employee until graduation
        \end{onecolentry}
