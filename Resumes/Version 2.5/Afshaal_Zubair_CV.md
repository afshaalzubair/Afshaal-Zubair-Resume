...
- Website: [www.afshaalzubair.com](https://www.afshaalzubair.com/)
...
- Pursuing Minor in Statistics and Data Science

# Skills

- Languages: Java, Python, JavaScript, HTML, CSS
- Frameworks/Libraries: Node.js, React.js, PyTorch, Pygame
- Developer Tools: Git, GitHub, VSCode, Eclipse, Vite
- Other Skills: Microsoft Office, Adobe Premiere Pro, Spline 3D
# Projects

## Conway's Conundrum

- [Github Repo](https://github.com/afshaalzubair/conways-game-of-life)
- A twist on the famous cellular automaton "Conway's Game of Life", which allows the user to experiment with a wide variety of custom parameters to create novel simulations.
- Built in Python using the Pygame library.

## austin.snowdropunited.org

- Currently In-progress
- Website for the Austin hub for Snowdrop United Corporation, featuring an interactive 3D landing page and information on Snowdrop's goals on feeding the homeless.
- Built using React.js, 3D components modeled in Spline.
...
- Developed alongside a team of three others using the Kivy/KivyMD Python framework.
...
## Directed Reading Program, Deep Learning Undergraduate Researcher

- Aug 2024 to present
- Austin, TX
- Orchestrated project based deep learning solutions, followed mentored research in meetings one hour per week.
- Explored a wide variety of machine learning/AI concepts including neural networks, CNNs, transformers, and diffusion models.
- Strengthened ability in developing deep learning models through the PyTorch framework.
